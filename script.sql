...
CREATE PROCEDURE LISTAR_PEDIDO_POR_ESTADO(
	IN _ESTADO_PEDIDO ENUM('Aceptado','Rechazado','Pendiente','Pagado','En_proceso'))
BEGIN
SELECT P.ID_PEDIDO,C.ID_CLIENTE,C.RUC,C.RAZON_SOCIAL,C.PUNTOS,P.ESTADO_PEDIDO,P.FECHA_REGISTRO,CV.ID_CLIENTE_VENDEDOR,E.ID_EMPLEADO,E.NOMBRE_EMPLEADO,E.APELLIDO_PATERNO,E.APELLIDO_MATERNO,P.TOTAL_PEDIDO
FROM PEDIDO P
...
CREATE PROCEDURE LISTAR_PEDIDO_POR_VENDEDOR_POR_ESTADO_PEDIDO(
    ...
    IN _ESTADO_PEDIDO ENUM('Aceptado','Rechazado','Pendiente','Pagado','En_proceso'))
BEGIN
SELECT P.ID_PEDIDO,C.ID_CLIENTE,C.RUC,C.RAZON_SOCIAL,C.PUNTOS,P.ESTADO_PEDIDO,P.FECHA_REGISTRO,CV.ID_CLIENTE_VENDEDOR,E.NOMBRE_EMPLEADO,E.APELLIDO_PATERNO,E.APELLIDO_MATERNO,P.TOTAL_PEDIDO
...
DROP PROCEDURE IF EXISTS LITAR_EMPLEADO_NO_ACTIVOS;
