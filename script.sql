...
BEGIN
SELECT * FROM PEDIDO
WHERE ESTADO_PEDIDO = _ESTADO_PEDIDO
AND ACTIVE = 1;
END$
...
BEGIN
	SELECT P.ID_PEDIDO,C.RUC,C.RAZON_SOCIAL,P.ESTADO_PEDIDO,P.FECHA_REGISTRO,CV.ID_CLIENTE_VENDEDOR,E.NOMBRE_EMPLEADO,E.APELLIDO_PATERNO,E.APELLIDO_MATERNO,P.TOTAL_PEDIDO
	FROM PEDIDO P
    ...
    WHERE P.ACTIVE = 1
    ORDER BY P.ESTADO_PEDIDO ASC, P.FECHA_REGISTRO ASC;
END$
