...
BEGIN
	SELECT P.ID_PEDIDO,C.RAZON_SOCIAL,P.ESTADO_PEDIDO,P.FECHA_REGISTRO,CV.ID_CLIENTE_VENDEDOR,E.NOMBRE_EMPLEADO,E.APELLIDO_PATERNO,E.APELLIDO_MATERNO,P.TOTAL_PEDIDO
	FROM PEDIDO P
