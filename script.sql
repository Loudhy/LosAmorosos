...
CREATE TABLE LINEA_PEDIDO(
    ...
    ESTADO_LINEA_PEDIDO ENUM('Disponible','No_disponible','Aceptado','Rechazado','Solicitado'),
...
CREATE TABLE PEDIDO(
    ...
    ESTADO_PEDIDO ENUM('Pendiente','En_proceso','Rechazado','Aceptado','Pagado') NOT NULL,
...
CREATE TABLE SOLICITUD(
    ...
    ESTADO_SOLICITUD ENUM('Pendiente','Rechazado','Aceptado') NOT NULL,
    FECHA_REGISTRO DATE NOT NULL,
    DESCRIPCION VARCHAR(80),
    ID_PEDIDO INT NOT NULL,
    ACTIVE TINYINT(1) NOT NULL
...
DROP PROCEDURE IF EXISTS ACTUALIZAR_PRESENTACION;
DROP PROCEDURE IF EXISTS ELIMINAR_PRESENTACION;
DROP PROCEDURE IF EXISTS ENCONTRAR_CLIENTE_POR_CLIENTE_VENDEDOR;
...
CREATE PROCEDURE LISTAR_CLIENTES_POR_VENDEDOR(
	IN _ID_VENDEDOR INT)
BEGIN	
SELECT CLIENTE.ID_CLIENTE, CLIENTE.RAZON_SOCIAL, CLIENTE.RUC, CLIENTE.DIRECCION, CLIENTE.TELEFONO_CLIENTE,
CLIENTE.TELEFONO_CLIENTE, CLIENTE.CORREO_CLIENTE, PROVINCIA.ID_PROVINCIA, PROVINCIA.NOMBRE_PROVINCIA,
DEPARTAMENTO.ID_DEPARTAMENTO, DEPARTAMENTO.NOMBRE_DEPARTAMENTO  
FROM CLIENTE, CLIENTE_VENDEDOR, PROVINCIA, DEPARTAMENTO
WHERE  PROVINCIA.ID_PROVINCIA = CLIENTE.ID_PROVINCIA
AND DEPARTAMENTO.ID_DEPARTAMENTO = PROVINCIA.ID_DEPARTAMENTO
...
BEGIN
	INSERT INTO EMPLEADO(NOMBRE_EMPLEADO, APELLIDO_PATERNO, APELLIDO_MATERNO, DNI_EMPLEADO,FECHA_NACIMIENTO,NOMBRE_USUARIO,CONTRASEÑA,TELEFONO_EMPLEADO,
	CORREO_EMPLEADO,ESTADO_CIVIL,SUELDO,ID_AREA,FECHA_INGRESO,ACTIVE)
	VALUES (_NOMBRE_EMPLEADO, _APELLIDO_PATERNO,_APELLIDO_MATERNO,_DNI_EMPLEADO,_FECHA_NACIMIENTO,_USUARIO,_CONTRASEÑA,_TELEFONO_EMPLEADO,
...
APELLIDO_MATERNO = _APELLIDO_MATERNO, FECHA_NACIMIENTO = _FECHA_NACIMIENTO, NOMBRE_USUARIO = _USUARIO, CONTRASEÑA = _CONTRASEÑA,
TELEFONO_EMPLEADO = _TELEFONO_EMPLEADO,CORREO_EMPLEADO = _CORREO_EMPLEADO, ESTADO_CIVIL = _ESTADO_CIVIL, SUELDO = _SUELDO, 
AREA = _ID_AREA, FECHA_INGRESO = _FECHA_INGRESO, FOTO = _FOTO
...
BEGIN
SELECT EMPLEADO.ID_EMPLEADO, EMPLEADO.DNI_EMPLEADO, EMPLEADO.NOMBRE_EMPLEADO,
EMPLEADO.APELLIDO_PATERNO, EMPLEADO.APELLIDO_MATERNO,
EMPLEADO.ESTADO_CIVIL, EMPLEADO.FECHA_NACIMIENTO,
EMPLEADO.NOMBRE_USUARIO, EMPLEADO.CONTRASEÑA,
EMPLEADO.FOTO, EMPLEADO.SUELDO, EMPLEADO.FECHA_INGRESO, EMPLEADO.ACTIVE, AREA.ID_AREA, AREA.NOMBRE_AREA, AREA.CODIGO_AREA FROM EMPLEADO, AREA
WHERE EMPLEADO.ACTIVE = TRUE
AND EMPLEADO.ID_AREA = AREA.ID_AREA
ORDER BY APELLIDO_PATERNO ASC,APELLIDO_MATERNO ASC, NOMBRE_EMPLEADO ASC;
END$
...
SELECT EMPLEADO.ID_EMPLEADO, EMPLEADO.DNI_EMPLEADO, EMPLEADO.NOMBRE_EMPLEADO,
EMPLEADO.APELLIDO_PATERNO, EMPLEADO.APELLIDO_MATERNO,
EMPLEADO.ESTADO_CIVIL, EMPLEADO.CORREO_EMPLEADO, EMPLEADO.TELEFONO_EMPLEADO,EMPLEADO.FECHA_NACIMIENTO,
EMPLEADO.CONTRASEÑA, EMPLEADO.NOMBRE_USUARIO,
EMPLEADO.FOTO, EMPLEADO.SUELDO, EMPLEADO.FECHA_INGRESO, EMPLEADO.ACTIVE, AREA.ID_AREA, AREA.NOMBRE_AREA, AREA.CODIGO_AREA FROM EMPLEADO, AREA
WHERE EMPLEADO.ID_AREA = AREA.ID_AREA
AND AREA.ID_AREA = _ID_AREA
AND EMPLEADO.ACTIVE = TRUE;
END$
...
BEGIN
INSERT INTO LINEA_PEDIDO(CANTIDAD,ID_PEDIDO,ID_PRODUCTO,SUBTOTAL,ESTADO_LINEA_PEDIDO,FECHA_ATENCION,CANTIDAD_A_ATENDER,ACTIVE)
VALUES(_CANTIDAD,_ID_PEDIDO,_ID_PRODUCTO,_SUBTOTAL,_ESTADO_LINEA_PEDIDO,_FECHA_ATENCION,_CANTIDAD_A_ATENDER,1);
...
BEGIN
UPDATE LINEA_PEDIDO
SET CANTIDAD = _CANTIDAD, ID_PRODUCTO = _ID_PRODUCTO, SUBTOTAL = _SUBTOTAL,
...
BEGIN
INSERT INTO META_MENSUAL(FECHA_INICIO,FECHA_FIN,CANTIDAD_OBJETIVO,DESCRIPCION_META_MENSUAL,ACTIVE)
VALUES (_FECHA_INICIO,_FECHA_FIN,_CANTIDAD_OBJETIVO,_DESCRIPCION_META_MENSUAL,_ACTIVE);
...
BEGIN
UPDATE META_MENSUAL
SET FECHA_INICIO = _FECHA_INICIO, FECHA_FIN = _FECHA_FIN,CANTIDAD_OBJETIVO = _CANTIDAD_OBJETIVO,
...
CREATE PROCEDURE ACTUALIZAR_PEDIDO(
	IN _ID_PEDIDO INT,
    IN _TOTAL_PEDIDO FLOAT,
    IN _ESTADO_PEDIDO ENUM('Aceptado','Rechazado','Pendiente','Pagado','En_proceso'),
    IN _FECHA_REGISTRO DATE)
BEGIN
UPDATE PEDIDO
...
PEDIDO.TOTAL_PEDIDO, 
PEDIDO.ID_CLIENTE_VENDEDOR, 
PEDIDO.ESTADO_PEDIDO, PEDIDO.FECHA_REGISTRO,
PEDIDO.FECHA_FACTURACION, PEDIDO.MONTO_FACTURADO,
PEDIDO.FECHA_PAGO,
 PEDIDO.ACTIVE FROM PEDIDO, CLIENTE_VENDEDOR
WHERE CLIENTE_VENDEDOR.ID_CLIENTE_VENDEDOR = PEDIDO.ID_CLIENTE_VENDEDOR 
AND CLIENTE_VENDEDOR.ID_VENDEDOR = _ID_VENDEDOR
AND PEDIDO.ACTIVE = TRUE
ORDER BY FECHA_REGISTRO DESC, ID_PEDIDO DESC;
END$
...
CREATE PROCEDURE LISTAR_PEDIDO_POR_CLIENTE(
	IN _ID_CLIENTE INT)
BEGIN
SELECT PEDIDO.ID_PEDIDO, PEDIDO.TOTAL_PEDIDO, 
PEDIDO.ID_CLIENTE_VENDEDOR, 
PEDIDO.FECHA_FACTURACION,
PEDIDO.FECHA_PAGO,PEDIDO.MONTO_FACTURADO,
PEDIDO.ESTADO_PEDIDO, PEDIDO.FECHA_REGISTRO, PEDIDO.ACTIVE FROM PEDIDO, CLIENTE_VENDEDOR
...
SELECT P.ID_PEDIDO,
    C.ID_CLIENTE,C.RUC,
    C.RAZON_SOCIAL,C.PUNTOS,
    P.ESTADO_PEDIDO,P.FECHA_REGISTRO,
    P.FECHA_FACTURACION,
	P.FECHA_PAGO,P.MONTO_FACTURADO,
    CV.ID_CLIENTE_VENDEDOR,E.ID_EMPLEADO,
    E.NOMBRE_EMPLEADO,E.APELLIDO_PATERNO,E.APELLIDO_MATERNO,P.TOTAL_PEDIDO
	FROM PEDIDO P
    INNER JOIN CLIENTE_VENDEDOR CV ON P.ID_CLIENTE_VENDEDOR = CV.ID_CLIENTE_VENDEDOR
    INNER JOIN CLIENTE C ON CV.ID_CLIENTE = C.ID_CLIENTE
    INNER JOIN EMPLEADO E ON CV.ID_VENDEDOR = E.ID_EMPLEADO
    WHERE P.ESTADO_PEDIDO = _ESTADO_PEDIDO
...
CREATE PROCEDURE INSERTAR_SOLICITUD(
    ...
    IN _ACTIVE TINYINT(1))
BEGIN
INSERT INTO SOLICITUD(ESTADO_SOLICITUD,DESCRIPCION,ID_PEDIDO,FECHA_REGISTRO,ACTIVE)
VALUES (_ESTADO_SOLICITUD,_DESCRIPCION,_ID_PEDIDO,_FECHA_REGISTRO,_ACTIVE);
...
CREATE PROCEDURE ACTUALIZAR_LINEA_SOLICITUD(
	IN _ID_LINEA_SOLICITUD INT,
    IN _ID_LINEA_PEDIDO INT,
    IN _CANTIDAD INT,
    IN _ESTADO_SOLICITUD ENUM('Aceptado','Rechazado','Pendiente'))
BEGIN
UPDATE LINEA_SOLICITUD
SET ID_LINEA_PEDIDO = _ID_LINEA_PEDIDO,
CANTIDAD = _CANTIDAD, ESTADO_LINEA_SOLICITUD = _ESTADO_SOLICITUD
WHERE LINEA_SOLICITUD.ID_LINEA_SOLICITUD = _ID_LINEA_SOLICITUD;
END$

CREATE PROCEDURE LISTAR_LINEAS_SOLICITUD(
	IN _ID_SOLICITUD INT)
BEGIN
SELECT LINEA_SOLICITUD.ID_LINEA_SOLICITUD, 
LINEA_SOLICITUD.CANTIDAD,LINEA_SOLICITUD.ESTADO_LINEA_SOLICITUD, LINEA_SOLICITUD.ID_LINEA_PEDIDO,
LINEA_PEDIDO.SUBTOTAL,
LINEA_PEDIDO.CANTIDAD_A_ATENDER, LINEA_PEDIDO.ESTADO_LINEA_PEDIDO,
PRODUCTO.NOMBRE_PRODUCTO, PRODUCTO.DESCRIPCION, PRODUCTO.ID_PRODUCTO FROM LINEA_SOLICITUD, LINEA_PEDIDO,PRODUCTO
...
CREATE PROCEDURE BUSCAR_SOLICITUD_POR_PEDIDO(
	IN _ID_PEDIDO INT)
BEGIN
SELECT s.ID_SOLICITUD, s.ESTADO_SOLICITUD, s.FECHA_REGISTRO, s.DESCRIPCION
FROM SOLICITUD s, PEDIDO p
WHERE p.ID_PEDIDO = _ID_PEDIDO
AND s.ID_PEDIDO = p.ID_PEDIDO;
END$
...
BEGIN
SELECT ID_CLIENTE,RAZON_SOCIAL,RUC,DIRECCION,TELEFONO_CLIENTE,PUNTOS,CORREO_CLIENTE,PROVINCIA.ID_PROVINCIA, PROVINCIA.NOMBRE_PROVINCIA,
DEPARTAMENTO.ID_DEPARTAMENTO, DEPARTAMENTO.NOMBRE_DEPARTAMENTO FROM CLIENTE, PROVINCIA, DEPARTAMENTO
WHERE RAZON_SOCIAL LIKE CONCAT(_FILTRO,'%')
AND PROVINCIA.ID_PROVINCIA = CLIENTE.ID_PROVINCIA
AND DEPARTAMENTO.ID_DEPARTAMENTO = PROVINCIA.ID_DEPARTAMENTO
AND CLIENTE.ACTIVE = 1;
END$
...
BEGIN
    ...
    WHERE ID_PRESENTACION = _ID_PRESENTACION;
END$
CREATE PROCEDURE ENCONTRAR_CLIENTE_POR_CLIENTE_VENDEDOR(
	IN _ID_CLIENTE_VENDEDOR INT)
BEGIN
SELECT CLIENTE.ID_CLIENTE, RUC, RAZON_SOCIAL,DIRECCION, TELEFONO_CLIENTE, ID_PROVINCIA, CORREO_CLIENTE, PUNTOS, CLIENTE.ACTIVE FROM CLIENTE
INNER JOIN CLIENTE_VENDEDOR
WHERE CLIENTE_VENDEDOR.ID_CLIENTE_VENDEDOR = _ID_CLIENTE_VENDEDOR
AND CLIENTE.ID_CLIENTE = CLIENTE_VENDEDOR.ID_CLIENTE;
END$
...
SELECT P.ID_PEDIDO,C.ID_CLIENTE,
    C.RUC,C.RAZON_SOCIAL,C.PUNTOS,
    P.ESTADO_PEDIDO,P.FECHA_REGISTRO,
    P.FECHA_FACTURACION,
	P.FECHA_PAGO,P.MONTO_FACTURADO,
    CV.ID_CLIENTE_VENDEDOR,E.ID_EMPLEADO,E.NOMBRE_EMPLEADO,E.APELLIDO_PATERNO,E.APELLIDO_MATERNO,P.TOTAL_PEDIDO
	FROM PEDIDO P
    INNER JOIN CLIENTE_VENDEDOR CV ON P.ID_CLIENTE_VENDEDOR = CV.ID_CLIENTE_VENDEDOR
    INNER JOIN CLIENTE C ON CV.ID_CLIENTE = C.ID_CLIENTE
    INNER JOIN EMPLEADO E ON CV.ID_VENDEDOR = E.ID_EMPLEADO
    WHERE P.ACTIVE = 1
    ORDER BY P.ESTADO_PEDIDO ASC, P.FECHA_REGISTRO DESC;
END$

DROP PROCEDURE IF EXISTS ACTUALIZAR_LINEA_PEDIDO_ACEPTADO;
CREATE PROCEDURE ACTUALIZAR_LINEA_PEDIDO_ACEPTADO(
			IN _ID_LINEA_PEDIDO INT)
BEGIN
			UPDATE LINEA_PEDIDO
			SET ESTADO_LINEA_PEDIDO = 'Aceptado', FECHA_ATENCION = CURDATE()
			WHERE ID_LINEA_PEDIDO = _ID_LINEA_PEDIDO;
END$

DROP PROCEDURE IF EXISTS ACTUALIZAR_LINEA_PEDIDO_SOLICITADO;
CREATE PROCEDURE ACTUALIZAR_LINEA_PEDIDO_SOLICITADO(
		IN _ID_LINEA_PEDIDO INT)
BEGIN
		UPDATE LINEA_PEDIDO
        SET ESTADO_LINEA_PEDIDO = 'Solicitado', FECHA_ATENCION = CURDATE()
        WHERE ID_LINEA_PEDIDO = _ID_LINEA_PEDIDO;
        
END$

DROP PROCEDURE IF EXISTS ACTUALIZAR_LINEA_PEDIDO_RECHAZADO;
CREATE PROCEDURE ACTUALIZAR_LINEA_PEDIDO_RECHAZADO(
			IN _ID_LINEA_PEDIDO INT)
BEGIN
			UPDATE LINEA_PEDIDO
			SET ESTADO_LINEA_PEDIDO = 'Rechazado', FECHA_ATENCION = CURDATE()
			WHERE ID_LINEA_PEDIDO = _ID_LINEA_PEDIDO;
END$

CREATE PROCEDURE LISTAR_CLIENTES_POR_RUC(
	_RUC VARCHAR(80))
BEGIN
SELECT ID_CLIENTE,RAZON_SOCIAL,RUC,DIRECCION,TELEFONO_CLIENTE,PUNTOS,CORREO_CLIENTE,PROVINCIA.ID_PROVINCIA, PROVINCIA.NOMBRE_PROVINCIA,
DEPARTAMENTO.ID_DEPARTAMENTO, DEPARTAMENTO.NOMBRE_DEPARTAMENTO FROM CLIENTE, PROVINCIA, DEPARTAMENTO
...
DROP PROCEDURE IF EXISTS LISTAR_CLIENTE_VENDEDOR_POR_RUC;
CREATE PROCEDURE LISTAR_CLIENTE_VENDEDOR_POR_RUC(
		IN _RUC VARCHAR(80))
BEGIN
		SELECT CLIENTE.ID_CLIENTE, CLIENTE.RAZON_SOCIAL, CLIENTE.RUC, CLIENTE.DIRECCION, CLIENTE.TELEFONO_CLIENTE,
		CLIENTE.TELEFONO_CLIENTE, CLIENTE.CORREO_CLIENTE, PROVINCIA.ID_PROVINCIA, PROVINCIA.NOMBRE_PROVINCIA,
		...
		AND CLIENTE_VENDEDOR.ID_VENDEDOR = _ID_VENDEDOR
		AND CLIENTE.ID_CLIENTE = CLIENTE_VENDEDOR.ID_CLIENTE
        AND CLIENTE.RUC LIKE CONCAT(_RUC,'%')
        AND CLIENTE.ACTIVE = 1;
END$


DROP PROCEDURE IF EXISTS LEVANTAR_EMPLEADO;
CREATE PROCEDURE LEVANTAR_EMPLEADO(
IN _ID_EMPLEADO INT)
BEGIN
	UPDATE EMPLEADO
	SET ACTIVE = 1
	WHERE ID_EMPLEADO = _ID_EMPLEADO AND ACTIVE = 0;
END$
...
DROP PROCEDURE IF EXISTS BUSCAR_META_MENSUAL_ACTIVA;
CREATE PROCEDURE BUSCAR_META_MENSUAL_ACTIVA()
BEGIN
SELECT * FROM META_MENSUAL
WHERE ACTIVE = 1;
END$

DROP PROCEDURE IF EXISTS BUSCAR_OBJETIVO_VENDEDOR_POR_VENDEDOR;
CREATE PROCEDURE BUSCAR_OBJETIVO_VENDEDOR_POR_VENDEDOR(
	IN _ID_VENDEDOR INT)
BEGIN
SELECT * FROM OBJETIVO_VENDEDOR
...
DROP PROCEDURE IF EXISTS LISTAR_PEDIDO_POR_VENDEDOR_POR_ESTADO_PEDIDO;
CREATE PROCEDURE LISTAR_PEDIDO_POR_VENDEDOR_POR_ESTADO_PEDIDO(
	IN _ID_VENDEDOR INT,
    IN _ESTADO_PEDIDO ENUM('Aceptado','Rechazado','Pendiente','Pagado','En_proceso'))
BEGIN
SELECT P.ID_PEDIDO,
C.ID_CLIENTE,C.RUC,C.RAZON_SOCIAL,C.PUNTOS,
P.ESTADO_PEDIDO,P.FECHA_REGISTRO,
CV.ID_CLIENTE_VENDEDOR,E.NOMBRE_EMPLEADO,
E.APELLIDO_PATERNO,E.APELLIDO_MATERNO,
P.TOTAL_PEDIDO,PEDIDO.FECHA_FACTURACION,
PEDIDO.FECHA_PAGO,PEDIDO.MONTO_FACTURADO
FROM PEDIDO P, CLIENTE_VENDEDOR CV, CLIENTE C, EMPLEADO E
WHERE P.ID_CLIENTE_VENDEDOR = CV.ID_CLIENTE_VENDEDOR
AND CV.ID_VENDEDOR = _ID_VENDEDOR
AND E.ID_EMPLEADO = CV.ID_VENDEDOR
AND C.ID_CLIENTE = CV.ID_CLIENTE
AND P.ESTADO_PEDIDO = _ESTADO_PEDIDO
AND P.ACTIVE = TRUE
ORDER BY FECHA_REGISTRO DESC;
END$

DROP PROCEDURE IF EXISTS LISTAR_PEDIDO_POR_VENDEDOR_POR_CLIENTE;
CREATE PROCEDURE LISTAR_PEDIDO_POR_VENDEDOR_POR_CLIENTE(
	IN _ID_VENDEDOR INT,
    IN _FILTRO VARCHAR(80))
BEGIN
SELECT P.ID_PEDIDO,C.ID_CLIENTE,
C.RUC,C.RAZON_SOCIAL,
C.PUNTOS,P.ESTADO_PEDIDO,
P.FECHA_REGISTRO,
P.FECHA_FACTURACION,
P.FECHA_PAGO,P.MONTO_FACTURADO,
CV.ID_CLIENTE_VENDEDOR,
E.NOMBRE_EMPLEADO,E.APELLIDO_PATERNO,
E.APELLIDO_MATERNO,P.TOTAL_PEDIDO
FROM PEDIDO P, CLIENTE_VENDEDOR CV, CLIENTE C, EMPLEADO E
WHERE P.ID_CLIENTE_VENDEDOR = CV.ID_CLIENTE_VENDEDOR
AND CV.ID_VENDEDOR = _ID_VENDEDOR
AND CV.ID_CLIENTE = C.ID_CLIENTE
AND E.ID_EMPLEADO = CV.ID_VENDEDOR
AND (C.RUC LIKE CONCAT(_FILTRO,'%') OR C.RAZON_SOCIAL LIKE CONCAT(_FILTRO,'%'))
AND P.ACTIVE = TRUE
ORDER BY ESTADO_PEDIDO ASC,FECHA_REGISTRO DESC;
END$

DROP PROCEDURE IF EXISTS LISTAR_TODOS_EMPLEADOS_POR_NOMBRE;
CREATE PROCEDURE LISTAR_TODOS_EMPLEADOS_POR_NOMBRE(
...
EMPLEADO.FOTO, EMPLEADO.SUELDO, EMPLEADO.FECHA_INGRESO, EMPLEADO.ACTIVE, AREA.ID_AREA, AREA.NOMBRE_AREA, AREA.CODIGO_AREA FROM EMPLEADO, AREA 
WHERE EMPLEADO.ID_AREA = AREA.ID_AREA
AND EMPLEADO.NOMBRE_EMPLEADO LIKE CONCAT(_NOMBRE,"%")
ORDER BY ACTIVE DESC,APELLIDO_PATERNO ASC,APELLIDO_MATERNO ASC, NOMBRE_EMPLEADO ASC;
END$

DROP PROCEDURE IF EXISTS LISTAR_EMPLEADO_NO_ACTIVOS;
CREATE PROCEDURE LISTAR_EMPLEADO_NO_ACTIVOS()
BEGIN
SELECT EMPLEADO.ID_EMPLEADO, EMPLEADO.DNI_EMPLEADO, EMPLEADO.NOMBRE_EMPLEADO,
EMPLEADO.APELLIDO_PATERNO, EMPLEADO.APELLIDO_MATERNO,
EMPLEADO.ESTADO_CIVIL, EMPLEADO.FECHA_NACIMIENTO,
EMPLEADO.NOMBRE_USUARIO, EMPLEADO.CONTRASEÑA,
EMPLEADO.FOTO, EMPLEADO.SUELDO, EMPLEADO.FECHA_INGRESO, EMPLEADO.ACTIVE, AREA.ID_AREA, AREA.NOMBRE_AREA, AREA.CODIGO_AREA FROM EMPLEADO, AREA
WHERE EMPLEADO.ACTIVE = FALSE
AND EMPLEADO.ID_AREA = AREA.ID_AREA
ORDER BY APELLIDO_PATERNO ASC,APELLIDO_MATERNO ASC, NOMBRE_EMPLEADO ASC;
END$

DROP PROCEDURE IF EXISTS LISTAR_PEDIDO_POR_VENDEDOR_POR_CLIENTE_POR_ESTADO;
CREATE PROCEDURE LISTAR_PEDIDO_POR_VENDEDOR_POR_CLIENTE_POR_ESTADO(
	IN _ID_VENDEDOR INT,
    IN _FILTRO VARCHAR(80),
    IN _ESTADO_PEDIDO ENUM('Aceptado','Rechazado','Pendiente','Pagado','En_proceso'))
BEGIN
...
P.FECHA_FACTURACION,
P.FECHA_PAGO,P.MONTO_FACTURADO,
CV.ID_CLIENTE_VENDEDOR,E.NOMBRE_EMPLEADO,E.APELLIDO_PATERNO,E.APELLIDO_MATERNO,P.TOTAL_PEDIDO
FROM PEDIDO P, CLIENTE_VENDEDOR CV, CLIENTE C, EMPLEADO E
WHERE P.ID_CLIENTE_VENDEDOR = CV.ID_CLIENTE_VENDEDOR
AND CV.ID_VENDEDOR = _ID_VENDEDOR
AND CV.ID_CLIENTE = C.ID_CLIENTE
...
DROP PROCEDURE LISTAR_PEDIDO_POR_CLIENTE_POR_FILTRO;
CREATE PROCEDURE LISTAR_PEDIDO_POR_CLIENTE_POR_FILTRO(
	IN _FILTRO VARCHAR(80))
BEGIN
SELECT P.ID_PEDIDO,C.ID_CLIENTE,
    C.RUC,C.RAZON_SOCIAL,C.PUNTOS,
...
DROP PROCEDURE IF EXISTS ACTUALIZAR_FECHA_PAGO;
CREATE PROCEDURE ACTUALIZAR_FECHA_PAGO(
	IN _ID_PEDIDO INT,
    IN _FECHA_PAGO DATE)
BEGIN
UPDATE PEDIDO
SET FECHA_PAGO = _FECHA_PAGO
WHERE ID_PEDIDO = _ID_PEDIDO;
END$

DROP PROCEDURE IF EXISTS ACTUALIZAR_FACTURACION_PEDIDO;
CREATE PROCEDURE ACTUALIZAR_FACTURACION_PEDIDO(
	IN _ID_PEDIDO INT,
	IN _FECHA_FACTURACION DATE,
    IN _MONTO_FACTURADO FLOAT)
BEGIN
UPDATE PEDIDO
SET FECHA_FACTURACION = _FECHA_FACTURACION, MONTO_FACTURADO = _MONTO_FACTURADO
WHERE ID_PEDIDO = _ID_PEDIDO;	
END$

DROP PROCEDURE IF EXISTS LISTAR_EMPLEADO_POR_AREA_POR_FILTRO;
CREATE PROCEDURE LISTAR_EMPLEADO_POR_AREA_POR_FILTRO(
	IN _ID_AREA INT,
	IN _FILTRO VARCHAR(80))
BEGIN
SELECT EMPLEADO.ID_EMPLEADO, EMPLEADO.DNI_EMPLEADO, EMPLEADO.NOMBRE_EMPLEADO,
...
EMPLEADO.FOTO, EMPLEADO.SUELDO, EMPLEADO.FECHA_INGRESO, EMPLEADO.ACTIVE, AREA.ID_AREA, AREA.NOMBRE_AREA, AREA.CODIGO_AREA FROM EMPLEADO, AREA
WHERE EMPLEADO.ID_AREA = AREA.ID_AREA
AND (EMPLEADO.NOMBRE_EMPLEADO LIKE CONCAT(_FILTRO,"%") OR EMPLEADO.APELLIDO_PATERNO LIKE CONCAT(_FILTRO,"%"))
AND AREA.ID_AREA = _ID_AREA
AND EMPLEADO.ACTIVE = TRUE;
END$

DROP PROCEDURE IF EXISTS LISTAR_EMPLEADO_POR_AREA_POR_DNI;
CREATE PROCEDURE LISTAR_EMPLEADO_POR_AREA_POR_DNI(
	IN _ID_AREA INT,
	IN _DNI VARCHAR(80))
BEGIN
SELECT EMPLEADO.ID_EMPLEADO, EMPLEADO.DNI_EMPLEADO, EMPLEADO.NOMBRE_EMPLEADO,
...
EMPLEADO.FOTO, EMPLEADO.SUELDO, EMPLEADO.FECHA_INGRESO, EMPLEADO.ACTIVE, AREA.ID_AREA, AREA.NOMBRE_AREA, AREA.CODIGO_AREA FROM EMPLEADO, AREA
WHERE EMPLEADO.ID_AREA = AREA.ID_AREA
AND EMPLEADO.DNI LIKE CONCAT(_DNI,"%")
AND AREA.ID_AREA = _ID_AREA
AND EMPLEADO.ACTIVE = TRUE;
END$
...
DROP PROCEDURE ELIMINAR_CLIENTE_VENDEDOR_CON_CLIENTE_Y_VENDEDOR;
CREATE ELIMINAR_CLIENTE_VENDEDOR_CON_CLIENTE_Y_VENDEDOR(
	IN _ID_CLIENTE INT,
    IN _ID_VENDEDOR INT)
BEGIN
UPDATE CLIENTE_VENDEDOR
...
DROP PROCEDURE VALIDAR_ELIMINACION;
CREATE PROCEDURE VALIDAR_ELIMINACION(
	IN _ID_CLIENTE INT,
    IN _ID_VENDEDOR INT)
BEGIN
SELECT * FROM PEDIDO, CLIENTE_VENDEDOR
WHERE PEDIDO.ID_CLIENTE_VENDEDOR = CLIENTE_VENDEDOR.ID_CLIENTE_VENDEDOR
AND CLIENTE_VENDEDOR.ID_CLIENTE = _ID_CLIENTE
AND CLIENTE_VENDEDOR.ID_VENDEDOR = _ID_VENDEDOR
AND CLIENTE_VENDEDOR.ACTIVE = 1;
END$