...
CREATE TABLE LINEA_PEDIDO(
    ...
    ESTADO_LINEA_PEDIDO ENUM('Disponible','No disponible','Aceptado','Rechazado','Solicitado'),
...
CREATE TABLE PEDIDO(
    ...
    ESTADO_PEDIDO ENUM('Aceptado','Rechazado','Pendiente','Pagado','En proceso') NOT NULL,
...
CREATE PROCEDURE ACTUALIZAR_LINEA_PEDIDO(
    ...
    IN _ID_PRODUCTO INT,
    IN _SUBTOTAL FLOAT,
    IN _ESTADO_LINEA_PEDIDO ENUM('Disponible','No_disponible','Aceptado','Rechazado','Pendiente'),
    IN _FECHA_ATENCION DATE,
    IN _CANTIDAD_A_ATENDER INT
)
BEGIN
...
CREATE PROCEDURE LISTAR_LINEAS_SOLICITUD(
	IN _ID_SOLICITUD INT)
BEGIN
SELECT LINEA_SOLICITUD.ID_LINEA_SOLICITUD, LINEA_SOLICITUD.ESTADO_LINEA_SOLICITUD,LINEA_SOLICITUD.ID_LINEA_PEDIDO,
...
>>>>>>> 8e7245ead6f6170754b861ee4d4c20ba7a3ad94a
